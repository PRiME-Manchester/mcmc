...
int main(void)
{
	double num1=-5.3245e3, num2=32.5463e300;
	...
	print_test(7, "%3.5f %6.2f %2.6f %03.6f %2.6f %.4f", 0.412, -0.02, 0.000231, -1.1234, -0.666687, 0.3);
	print_test(8, "%3.5e", num1);
	print_test(9, "%3.5e", num2);
